...
These differ in some details based on the Virus (like we saw earlier, they can be frustratingly diverse). But the fundamentals remain the same. Let's dive in!
